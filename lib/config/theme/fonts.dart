...
class AppFonts {
  ...
  static const double kFontTitleLarge = 24;
  static const double kFontTitleMedium = 18;
  static const double kFontTitleSmall = 14;

  static const double kFontBodyLarge = 16;
  static const double kFontBodyMedium = 14;
